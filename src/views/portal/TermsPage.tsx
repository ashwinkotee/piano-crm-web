  ...
  return (
    <div className="space-y-4">
      ...
      <div className="card-neutral rounded-2xl p-4 shadow-sm space-y-4 text-sm">
        <div>
          <div className="font-medium">1. Class Structure</div>
          <p className="mt-1">
        ...
        <div>
          <div className="font-medium">2. Payments & Fees</div>
          <p className="mt-1">
        ...
        <div>
          <div className="font-medium">3. Rescheduling & Cancellations</div>
          <p className="mt-1">
        ...
        <div>
          <div className="font-medium">4. Public Holidays & Instructor Absence</div>
          <p className="mt-1">
        ...
        <div>
          <div className="font-medium">5. Class Conduct & Materials</div>
          <p className="mt-1">
        ...
        <div>
          <div className="font-medium">6. Photography & Video</div>
          <p className="mt-1">
        ...
        <div>
          <div className="font-medium">7. Safety & Security</div>
          <p className="mt-1">
        ...
        <div>
          <div className="font-medium">8. Practice & Homework</div>
          <p className="mt-1">
